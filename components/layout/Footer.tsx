        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/discover" className="text-muted-foreground hover:text-primary text-sm">
                  Discover
                </Link>
              </li>
              <li>
                <Link href="/search" className="text-muted-foreground hover:text-primary text-sm">
                  Search
                </Link>
              </li>
              <li>
                <Link href="/success-stories" className="text-muted-foreground hover:text-primary text-sm">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/safety" className="text-muted-foreground hover:text-primary text-sm">
                  Safety Tips
                </Link>
              </li>
            </ul>
